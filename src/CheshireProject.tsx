...
const segments = [
  { number:"1", name:"Clinics", icon:Building2, tone:"blue", profitCenter:["Clinic location"], provider:["Individual therapist"], services:["PT","OT – General","OT – Feeding","Speech"], revenue:["Commercial – fee for service","Capitated plans","Medicaid","Patient responsibility","Self-pay"], labor:["Therapist wages","Payroll taxes","Benefits","Contract labor","PTO / nonproductive time","Documentation / prep"], expenses:["Rent","Utilities","Cleaning","Dumpster","Clinical supplies","Equipment","Repairs & maintenance"] },
  { number:"2", name:"Schools", icon:GraduationCap, tone:"orange", profitCenter:["School district / contract","Individual school"], provider:["Individual therapist"], services:["PT hours","OT hours","Speech hours"], revenue:["Hourly contract","Fixed contract","Other contract rate","Invoiced","Collected","Outstanding A/R"], labor:["Therapist school hours","Payroll burden","Contract labor","Travel time","Documentation / prep"], expenses:["Mileage / travel","School supplies","Contract-specific costs","District fees"] },
  { number:"3", name:"Private Programs", icon:Waves, tone:"green", profitCenter:["Program location","Program / session"], provider:["Instructor / therapist"], services:["Swim lessons","DMI / Intensives","Other programs"], revenue:["Single-session sales","Packages","Cash / card","Discounts / refunds"], labor:["Instructor / therapist wages","Payroll burden","Contract instructors","Setup / prep time"], expenses:["Program supplies","Pool / facility cost","Equipment","Program marketing","Merchant processing fees"] },
];
